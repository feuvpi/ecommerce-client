<template>
    <section class="relative rounded-lg overflow-hidden shadow-lg bg-slate-300">
        <div class="flex flex-wrap">
            ...
            <div class="flex flex-wrap w-full p-4">
                <div class="w-full font-bold text-xl mb-2">{{ product.name }}</div>
                ...
                <div class="w-full flex justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button class="bg-indigo-400 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded inline-flex items-center" 
